                ...
                : SingleChildScrollView(
                    child: Column(mainAxisSize: MainAxisSize.max, children: [
                      _userProfileController
                              .userProfileModel.value!.user!.userImages!.isEmpty
                          ? Container(
                              ...
                              onHorizontalDragStart: (details) {
                                if (details.localPosition.dx >
                                  ...
                                  if (currentImageCount == 0) {
                                    currentImageCount = _userProfileController
                                            .userProfileModel
                                            .value!
                                            .user!
                                            .userImages!
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        shareButton(Icon(Icons.share_outlined),
                                            () {
                                          Share.share(
                        ...
                        child: Column(
                          ...
                          children: [
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () {
                                      ...
                                      print(
                                          'Previous screen was: $previousScreen');
                                  ...
                                  InkWell(
                                      ...
                                      child: textColumn(
                                          _myCheckInController.checkin.length
                                              .toString(),
                                          "Checkins")),
                                ],
                              ),
                            ...
                            Transform.translate(
                              ...
                              child: Text(
                                _userProfileController
                                    .userProfileModel.value!.user!.userName!,
                                style: TextStyle(
